...
[[ ! -e /usr/share/glib-2.0/schemas/org.gnome.extensions.user-theme.gscheme.xml ]] && sudo ln -s ${HOME}/.dotfiles/ubuntu/schemas/org.gnome.shell.extensions.user-theme.gschema.xml /usr/share/glib-2.0/schemas/
